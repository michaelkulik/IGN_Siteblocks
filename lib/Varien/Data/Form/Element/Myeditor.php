    ...
    public function __construct($attributes=array())
    {
        ...
        if (Mage::getSingleton('cms/wysiwyg_config')->isEnabled()) {
            ...
            $this->setData([
                ...
                'style' => 'height:16em' // добавил я, работает высота поля ввода
            ]);
            // строчка выше - это замена вот этому в поле content в форме:
            // 'config'    => Mage::getSingleton('cms/wysiwyg_config')->getConfig()
            // но в System->Configuration мы так через xml конфиг сделать не можем, поэтому
            // сделаем в строке выше
        }
